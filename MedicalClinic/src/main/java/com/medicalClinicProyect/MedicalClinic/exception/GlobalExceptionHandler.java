...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ValidationExceptionResponse> MethodArgumentNotValidExceptionHandler(MethodArgumentNotValidException ex, HttpServletRequest request){
    ...
    public ResponseEntity<ExceptionResponse> MethodArgumentNotValidExceptionHandler(SQLIntegrityConstraintViolationException ex, HttpServletRequest request){
    ...
    public ResponseEntity<ExceptionResponse> PasswordNotMatchesExceptionHandler(PasswordNotMatchesException ex, HttpServletRequest request){
    ...
    public ResponseEntity<ExceptionResponse> ResourceNotFoundExceptionHandler(ResourceNotFoundException ex, HttpServletRequest request){
    ...
    @ExceptionHandler(WrongAccountRequestException.class)
    public ResponseEntity<ExceptionResponse> WrongAccountRequestExceptionHandler(WrongAccountRequestException ex, HttpServletRequest request){
    ...
    public ResponseEntity<ExceptionResponse> AppointmentNotAvailableExceptionHandler(AppointmentNotAvailableException ex, HttpServletRequest request){
